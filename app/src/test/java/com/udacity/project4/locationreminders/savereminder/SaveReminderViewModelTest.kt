...
class SaveReminderViewModelTest {
    ...
    fun validateEnteredData_EmptyTitleAndUpdateSnackBar() {
        val reminder = ReminderDataItem("", "Buy vegetables and fruits", "Local Market", 7.34567, 6.87654)
    ...
    fun validateEnteredData_EmptyLocationAndUpdateSnackBar() {
        val reminder = ReminderDataItem("Grocery Shopping", "Buy vegetables and fruits", "", 7.34567, 6.87654)
    ...
    fun saveReminder_showLoading(){
        val reminder = ReminderDataItem("Grocery Shopping", "Buy vegetables and fruits", "Local Market", 7.34567, 6.87654)
